    ...
    <div className="pcos-page">
      ...
      <div className="container">
        <div className="summary-row">
          <img
            src="pcos 1st pic.jpg"
            alt="Illustration showing PCOS condition"
          />
          <div className="summary-text">
            <h2>What is PCOS?</h2>
            <p>
              Polycystic Ovary Syndrome (PCOS) is a hormonal disorder that
              affects approximately 5 to 10 million women in the United States.
              Despite being common, it often goes undiagnosed due to its wide
              range of symptoms. Women who are suffering from PCOS usually have
              a variety of symptoms but can also be asymptomatic — which is
              usually the reason for no diagnosis. Our purpose is to help people
              find out if they may need support or further screening.
            </p>
          </div>
        </div>
        ...
        <div className="content-grid">
          <div className="section">
            ...
            <p>
              ...
              periods. It is important to note that a cycle with PCOS may have:
            </p>
            <ul>
            ...
            <p>
              If you have two of these three symptoms, you may be diagnosed with
              PCOS. It is important to note that advocating for an ultrasound is
              crucial, as it is not always requested. The ultrasound will check
              for the presence of cysts on the ovaries and can often show the
              size of the ovaries and how many cysts are present, which blood
              work cannot do.
            </p>
          </div>
          ...
          <div className="pcos-section">
            ...
            <p>
              Physical symptoms can vary from person to person. It is important
              to note that symptoms may come and go with time and can be traced
              back to as early as one's first period. However, some people can
              go asymptomatic and may never realize there is an issue until they
              are dealing with infertility. Some symptoms may include:
            </p>
            <ul>
              <li>Facial hair</li>
              <li>Weight gain</li>
        ...
        <div className="section">
          ...
          <p>
            ...
            and weight gain. With PCOS, it is best to avoid fried foods, foods
            that are heavy on butter, limit red meat intake, refined flour,
            alcohol, and white rice. It is best to eat foods such as:
          </p>
          <ul>
            <li>
            ...
            <li>
              Foods that are high in fiber such as beans, lentils, and chickpeas
            </li>
            <li>
          ...
          <h2>Medication:</h2>
          <p>
            Medication can be prescribed depending on what your PCOS affects in
            your body, as not everyone has the same symptoms and effects on
            their bodies.
          </p>
          <p>
            Some medications that can help manage symptoms such as irregular or
            missed periods include birth control pills, which can help regulate
            your menstrual cycle and reduce symptoms such as acne and excessive
            hair growth. This is often what is most recommended by doctors and
            usually the first step in treatment. If blood work shows that you
            have high levels of insulin, your doctor may also recommend
            medications such as metformin, which is typically a diabetes
            medication but can stop the insulin resistance in one's body.
            Metformin can also help with weight loss when dealing with PCOS.
          </p>
          <p>
            If your PCOS is causing you to skip the ovulation phase, clomiphene
            can be prescribed to help ovulate. This medication can help by
            allowing the release of more estrogen in your body, which causes you
            to ovulate. There are some side effects such as hot flashes, mood
            swings, headaches, nausea, etc. If the symptoms get too bad, then
            spironolactone is recommended, which has the same effect with fewer
            symptoms.
          </p>
          <p>
            It is important to note that everyone's body is different, and
            talking to your gynecologist or endocrinologist is essential in your
            journey in dealing with PCOS.
          </p>
        </div>
